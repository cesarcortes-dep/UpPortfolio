          ...
          >
            ...
            <div className="qualification__data">
              ...
              <div>
                ...
                <span className="qualification__subtitle">Virtual Data</span>
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt">April.2022 - Agu.2023</i>
                </div>
              </div>
            </div>
            {/* ------------------------------------------- */}
            ...
            <div className="qualification__data">
              <div>
                ...
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt">Jan.2022 - Agu.2022</i>
                </div>
              </div>
              <div>
                <span className="qualification__rounder"></span>
            ...
            <div className="qualification__data">
              ...
              <div>
                ...
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt">Janu.2023 - June.2023</i>
                </div>
              </div>
            </div>
            {/* ------------------------------------------- */}
            <div className="qualification__data">
              <div>
                ...
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt">Jan.2023 - July.2023</i>
                </div>
              </div>
              <div>
                <span className="qualification__rounder"></span>
